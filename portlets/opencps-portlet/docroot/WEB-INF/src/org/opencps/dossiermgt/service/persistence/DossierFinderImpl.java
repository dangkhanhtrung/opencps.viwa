...
public class DossierFinderImpl extends BasePersistenceImpl<Dossier> implements
	 ...
	 * @return
	 */
	private int countDossier(long groupId, String[] keywords,
	...
	public int countDossierByKeywordDomainAndStatus(long groupId,
			String keyword, String domainCode, String dossierStatus) {
	...
	private int countDossierByKeywordDomainAndStatus(long groupId,
			String[] keywords, String domainCode, String dossierStatus,
			boolean andOperator) {
	...
	private int countDossierByUser(long groupId, long userId,
		...
		try {
			...
			if (Validator.isNull(serviceDomainTreeIndex)) {
				...
				if (StringUtil.contains(serviceDomainTreeIndex,
						StringPool.PERIOD)) {
					sql = StringUtil
							.replace(
									sql,
	 ...
	 * @return
	 */
	public List<Dossier> searchDossier(long groupId, String keyword,
	 ...
	 * @return
	 */
	private List<Dossier> searchDossier(long groupId, String[] keywords,
	...
	public List<Dossier> searchDossierByKeywordDomainAndStatus(long groupId,
			String keyword, String domainCode, String dossierStatus, int start,
