...
/**
 * Provides the local service interface for MessageFunctionData. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhth
 * @see MessageFunctionDataLocalServiceUtil
...
public interface MessageFunctionDataLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MessageFunctionDataLocalServiceUtil} to access the message function data local service. Add custom service methods to {@link org.duongthuy.tichhop.api.dao.service.impl.MessageFunctionDataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
